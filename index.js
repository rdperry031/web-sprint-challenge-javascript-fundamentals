...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
   const animals = [];
    array.forEach(item =>animals.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`, ));
  return animals
  }
  ...
  */
  ...
  function lowerCaseNames(array){
    ...
    array.map(item => item.animal_name.toLowerCase())
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPop =
    array.filter(item => item.population < 5);
    return lowPop;
  }
